          ...
          child: ListView(
            children: [
              TextFormField(
                ...
                validator: (value) =>
                (value == null || value.isEmpty) ? 'Введите логин аккаунта' : null,
              ),
              TextFormField(
                controller: _userNameController,
                decoration: const InputDecoration(labelText: 'Имя пользователя'),
                validator: (value) =>
                (value == null || value.isEmpty) ? 'Введите имя пользователя' : null,
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Описание пользователя (необязательно)'),
              ),
              TextFormField(
              ...
              TextFormField(
                ...
                obscureText: true,
                validator: (value) =>
                value != _passwordController.text ? 'Пароли не совпадают' : null,
              ),
                ...
                onPressed: _isLoading
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    try {
                      ...
                      final account = await AccountService().fetchAccountById(result['account_id']);
                      final user = await UserService().fetchUserById(result['user_id']);
